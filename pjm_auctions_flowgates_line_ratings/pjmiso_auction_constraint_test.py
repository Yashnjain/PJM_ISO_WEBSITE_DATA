...
import bu_alerts
sys.path.append(r'\\biourja.local\biourja\Groups\Gas & Pwr\Pwr\FTR\Virtuals\Michael\bulog')
...
def get_longterm_ftr_auction(databasename, schemaname, tablename):
    ...
    tree = html.fromstring(page.content)
    # path = "/html/body/form/div[4]/div/div/div[2]/div/article/div/div[1]/div[16]/div/div/table//tr[position()]/td[1]/a/@href"
    path = "/html/body/form/div[4]/div/div/div[2]/div/article/div/div[1]/div[16]/div/div/table/tbody/tr[1]/td[1]/a"
    table = tree.xpath(path)
...
def get_monthly_ftr_auction(databasename, schemaname, tablename):
    ...
    page = requests.get(credential_dict['SOURCE_URL'].split(';')[1])
